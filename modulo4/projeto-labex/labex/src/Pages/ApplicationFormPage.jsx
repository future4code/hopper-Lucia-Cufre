...
function ApplicationForm() {
  ...
  const [allTrips] = useRequestedData("/trips", {});
  const navigate = useNavigate();

  const applyToTrip = (tripId) => {
    const url = `${baseURL}/trips/${tripId}/apply`;
    const body = {
      name: form.name,
      age: form.age,
      ...
      >
        <form onSubmit={submit}>
          ...
          <TextField
            ...
            required
            select
            helperText="Por favor escolha o país onde mora"
          >
          ...
          >
            <ButtonGroup variant="text" aria-label="text button group">
              <Button onClick={() => applyToTrip(tripId)}>ENVIAR </Button>
